...
public class FirestoreBarChartRealTimeExample {

    private DefaultCategoryDataset dataset;
    private JFrame frame;

    public FirestoreBarChartRealTimeExample() {
        try {
    ...
    private void setupRealTimeListener(Firestore db) {
        ...
        frame.setTitle("Student Ages Bar Chart (Real-Time)");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(FirestoreBarChartRealTimeExample::new);
    }
}
